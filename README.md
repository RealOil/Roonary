...
```text
Onboarding -> My Room -> Today -> Archive
```
...
4. 오늘 화면에서 현재 집중 루틴을 바꿔본다.
5. 오늘 화면에서 오늘 일정과 위젯 미리보기를 확인한다.
6. 오늘 로그에서 프레임 생성, 요약, 생성된 프레임을 확인한다.
7. 옷장에서 캐릭터 꾸미기 / 방 꾸미기 탭이 전환되는지 확인한다.
8. 아카이브 placeholder가 열리는지 확인한다.
```
